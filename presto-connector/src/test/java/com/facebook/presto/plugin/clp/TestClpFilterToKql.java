...
@Test
public class TestClpFilterToKql extends TestClpQueryBase {
    @Test
    public void testStringMatchPushDown() {
        ...
        testPushDown(
                sessionHolder,
                "city.Name = 'hello world'",
                "city.Name: \"hello world\"",
                null
        );
        testPushDown(
                sessionHolder,
                "'hello world' = city.Name",
                "city.Name: \"hello world\"",
                null
        );
        ...
        testPushDown(
                sessionHolder,
                "city.Name like 'hello%world'",
                "city.Name: \"hello*world\"",
                null
        );
        testPushDown(
                sessionHolder,
                "city.Name like 'hello%wor%ld'",
                "city.Name: \"hello*wor*ld\"",
                null
        );
    }
    ...
    public void testSubStringPushDown() {
        ...
        testPushDown(
                sessionHolder,
                "substr(city.Name, 1, 5) = 'he'",
                null,
                "substr(city.Name, 1, 5) = 'he'"
        );
        testPushDown(
                sessionHolder,
                "substr(city.Name, -5) = 'he'",
                null,
                "substr(city.Name, -5) = 'he'"
        );
    }
    ...
    public void testNotPushDown() {
        ...
        testPushDown(
                ...
                "NOT city.Region.Name: \"hello*\"",
                null
        );
        testPushDown(
                sessionHolder,
                "NOT (city.Region.Name LIKE 'hello%')",
                "NOT city.Region.Name: \"hello*\"",
                null
        );
        testPushDown(
    ...
    public void testTimestampPushDown() {
        ...
        testPushDown(
                sessionHolder,
                "clpTimestamp > TIMESTAMP '2023-01-01 00:00:00.000'",
                "clpTimestamp > timestamp(\"1672531200000\", \"\\L\")",
                null
        );
        testPushDown(
                sessionHolder,
    ...
    public void testClpWildcardUdf() {
        ...
        testPushDown(
                sessionHolder,
                "CLP_WILDCARD_STRING_COLUMN() like 'hello%'",
                "*: \"hello*\"",
                null
        );
        testPushDown(
                sessionHolder,
                "substr(CLP_WILDCARD_STRING_COLUMN(), 1, 2) = 'he'",
                "*: \"he*\"",
                null
        );
        testPushDown(
                sessionHolder,
                "CLP_WILDCARD_INT_COLUMN() BETWEEN 0 AND 5",
                "* >= 0 AND * <= 5",
                null
        );
        testPushDown(
                sessionHolder,
                "CLP_WILDCARD_STRING_COLUMN() IN ('hello world', 'hello world 2')",
                "(*: \"hello world\" OR *: \"hello world 2\")",
                null
        );
    ...
    private void testPushDown(
        ...
        assertEquals(
                clpExpression.getMetadataExpression().isPresent(),
                expectedMetadataSqlQuery != null
        );
    }
    ...
    private void testFilter(
        ...
        if (expectedRemainingExpression != null) {
            ...
            assertEquals(
                    ...
                    getRowExpression(expectedRemainingExpression, sessionHolder)
            );
        } else {
