...
public class ClpConfig {
    ...
    public String getSplitMetadataConfigPath() { return splitMetadataConfigPath; }
    ...
    public String getIntegrationTestArchiveDir() { return integrationTestArchiveDir; }
