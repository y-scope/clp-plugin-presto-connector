...
3. Declare the factory in your jar's
   `META-INF/services/com.facebook.presto.plugin.clp.split.ClpSplitProviderFactory` (or
   `...clp.metadata.ClpMetadataProviderFactory`).
